...
\item Introduction to the course and to the brain. (a 28-01)
\item More on the brain. (a 30-01)
\item Still more on the brain. (a 04-02)

\item Introduction to differential equations. (b 06-02)
\item Numerical solutions to differential equations. (b 11-02)

\item Modelling neurons. (c 13-02)
\item The McCulloch-Pitts neuron, Perceptrons, and Hopfield networks. (d 18-02)
...
\item Firing rates, dealing with neuronal data, receptive fields. (f 27-02)
\newline \newline [Reading week]
  
\item The visual system. (g 10-03)

\item V1 and sparse coding. (g 12-03)
\item Spikes and analysing spike date. (h 17-03)

\item Leaky integrate and fire model neurons. F--I curves (h 19-03)
\item Synapses and synaptic plasticity. (i 24-03)
\item Short-term synaptic plasticity (i 26-03)
\newline \newline [Easter break, 3 weeks]
\item Long term synaptic plasticity. (i 21-04)
\item Q+A session with lecturers (23-04)
...
Taught last year but likely to be dropped this year to allow for revision week:
\begin{enumerate}
\item Dynamical systems approaches, the Morris-Lecar model, phase diagrams. (k)
