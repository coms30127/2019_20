...
\subsection*{COMSM2127 [20 marks]} Now set $B=0$ and $r_0 = 15$ Hz again, and simulate for 300 s. Measure the temporal cross-correlogram $\rho_{i}(\Delta t)$ between all presynaptic neurons and the postsynaptic neuron (where the subscript $i$ indexes the presynaptic
